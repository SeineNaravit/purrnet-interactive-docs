...
export const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "2D Side Scrolling Controller",       titleKey: "sidebar.pages.sideScrolling2D",           href: "/docs/2d-side-scrolling-controller",        badge: "Example" },
      { title: "2.5D Side Scrolling Controller",     titleKey: "sidebar.pages.sideScrolling25D",          href: "/docs/2-5d-side-scrolling-controller",      badge: "Example" },
      { title: "Strategy Unit Commander",            titleKey: "sidebar.pages.strategyUnitCommander",     href: "/docs/strategy-unit-commander",             badge: "Example" },
      { title: "Grid Survival Crafting",             titleKey: "sidebar.pages.gridSurvivalCrafting",      href: "/docs/grid-survival-crafting",              badge: "Example" },
      { title: "Character Creation System",          titleKey: "sidebar.pages.characterCreationSystem",   href: "/docs/character-creation-system",           badge: "Example" },
